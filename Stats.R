...
# For example: is 68% male promoted unusual if 58% of workers male?
...
## Favoritism 2 ----
# Presume 2 fewer women promoted, so now 27 men and 11 women 
...
# Import fl_crime.csv as crime
crime <- read_csv("data/fl_crime.csv")
...
# Coefficients: 
## (Intercept) is where line intersecs y-axis (income)
